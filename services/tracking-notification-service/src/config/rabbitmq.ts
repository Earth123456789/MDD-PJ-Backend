// tracking-notification-service/src/config/rabbitmq.ts
...
const setupQueues = async (): Promise<void> => {
  // Define queues specific to tracking-notification service
  const queues = [
    'order-events',          // เหตุการณ์เกี่ยวกับออเดอร์
    'tracking-events',       // เหตุการณ์เกี่ยวกับการติดตาม
    'driver-location-events', // เหตุการณ์อัพเดทตำแหน่งคนขับ
    'notification-events',    // เหตุการณ์การแจ้งเตือน
    'user-events'            // เพิ่มเหตุการณ์เกี่ยวกับผู้ใช้
  ];
