...
class EventHandler:
    ...
    async def handle_order_matched(self, data: Dict[str, Any]):
        ...
        try:
            ...
            order_tracking = await self.order_service.get_order_tracking(int(order_id))
    ...
    async def handle_order_created(self, data: Dict[str, Any]):
        ...
        try:
            ...
            existing_order = await self.order_service.get_order_tracking(int(order_id))
            if existing_order:
    ...
    async def handle_driver_registered(self, data: Dict[str, Any]):
        ...
        try:
            ...
            existing_location = await self.location_service.get_driver_location(int(driver_id))
