...
class ConnectionManager:
    ...
    def __init__(self):
        ...
        self.driver_connections: Dict[int, Set[str]] = {}  # driver_id -> set of connection_ids
        self.user_connections: Dict[int, Set[str]] = {}  # user_id -> set of connection_ids
        self.order_subscribers: Dict[int, Set[str]] = {}  # order_id -> set of connection_ids
    ...
    async def broadcast_to_drivers(self, driver_ids: List[int], message: Dict[str, Any]):
        """
    ...
    async def send_to_driver(self, driver_id: int, message: Dict[str, Any]):
        """
    ...
    async def broadcast_order_update(self, order_id: int, message: Dict[str, Any]):
        """
    ...
    async def unsubscribe_from_order(self, connection_id: str, order_id: int):
        """
